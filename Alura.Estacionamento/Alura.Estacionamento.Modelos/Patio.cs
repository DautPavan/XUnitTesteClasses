    ...
    {       
        ...
        public Veiculo PesquisaVeiculo(string idTicket)
        {
            return ( from veiculo in this.Veiculos
                    where veiculo.IdTicket.Equals(idTicket)
                    select veiculo
                ).FirstOrDefault();

        }

        public Veiculo AlterarDadosVeiculo(Veiculo alteradoVeiculo)
        {
            var veiculoTemp = (from veiculo in this.Veiculos
                    where veiculo.Placa.Equals(alteradoVeiculo.Placa)
                    select veiculo
                ).FirstOrDefault();

            veiculoTemp.AlterarDados(alteradoVeiculo);
