...
namespace Alura.Estacionamento.Modelos
{
    public class Veiculo : IEnumerable<object[]>
    {
        ...
        public string Proprietario
        {
            ...
            {
                if (value.Length < 3)
                    throw new FormatException("Nome de proprietario muito curto");
        ...
        public void AlterarDados(Veiculo alteradoVeiculo)
        {
            this.Proprietario = alteradoVeiculo.Proprietario;
            this.Modelo = alteradoVeiculo.Modelo;
            this.Largura = alteradoVeiculo.Largura;
            this.Cor = alteradoVeiculo.Cor;
        }
